...
function nav(path) {
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    html += `
<li class="nav-item">
    <a class="nav-link" href="#" target="_blank"><i class="fas fa-save"
    ...
    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" id="navbarDropdown" role="button"
        data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Mais</a>
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="https://docs.medvideos.su/Copyright" target="_blank"><i
                        class="far fa-copyright" class="basicIcon"></i> Política de Copyright</a>
                <a class="dropdown-item" href="https://docs.medvideos.su/Privacidade" target="_blank"><i
